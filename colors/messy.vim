...
hi FoldColumn guifg=#008080 guibg=#808080 guisp=NONE gui=NONE ctermfg=6 ctermbg=8 cterm=NONE
hi Folded guifg=#008080 guibg=NONE guisp=NONE gui=NONE ctermfg=6 ctermbg=NONE cterm=NONE
...
hi PmenuSbar guifg=NONE guibg=#800080 guisp=NONE gui=NONE ctermfg=NONE ctermbg=5 cterm=NONE
hi PmenuSel guifg=#ffffff guibg=#ff00ff guisp=NONE gui=NONE ctermfg=15 ctermbg=13 cterm=NONE
hi PmenuThumb guifg=NONE guibg=#008080 guisp=NONE gui=NONE ctermfg=0 ctermbg=6 cterm=NONE
...
hi SignColumn guifg=#008080 guibg=#808080 guisp=NONE gui=NONE ctermfg=6 ctermbg=8 cterm=NONE
...
if exists('g:colorscheme_messy_transparent') && g:colorscheme_messy_transparent
    hi EndOfBuffer guifg=#808080 guibg=NONE guisp=NONE gui=NONE ctermfg=8 ctermbg=NONE cterm=NONE
