...
hi ColorColumn guifg=NONE guibg=#c0c0c0 guisp=#c0c0c0 gui=NONE ctermfg=NONE ctermbg=7 cterm=NONE
...
hi CursorColumn guifg=#ffffff guibg=#008080 guisp=NONE gui=NONE ctermfg=15 ctermbg=6 cterm=NONE
hi CursorLine guifg=#ffffff guibg=#008080 guisp=NONE gui=NONE ctermfg=15 ctermbg=6 cterm=NONE
hi CursorLineNr guifg=#ffffff guibg=#008080 guisp=#008080 gui=NONE ctermfg=15 ctermbg=6 cterm=NONE
...
hi EndOfBuffer guifg=#c0c0c0 guibg=#ffffff guisp=#ffffff gui=NONE ctermfg=7 ctermbg=15 cterm=NONE
hi Error guifg=#000000 guibg=#ff0000 guisp=#ff0000 gui=bold ctermfg=0 ctermbg=9 cterm=underline
...
hi FoldColumn guifg=#008080 guibg=#c0c0c0 guisp=#c0c0c0 gui=NONE ctermfg=6 ctermbg=7 cterm=NONE
...
hi LineNr guifg=#ffffff guibg=#808080 guisp=#808080 gui=NONE ctermfg=15 ctermbg=8 cterm=NONE
...
hi Pmenu guifg=#ffffff guibg=#800080 guisp=#800080 gui=NONE ctermfg=15 ctermbg=5 cterm=NONE
hi PmenuSbar guifg=NONE guibg=#808080 guisp=#808080 gui=NONE ctermfg=NONE ctermbg=8 cterm=NONE
hi PmenuSel guifg=#ffffff guibg=#ff00ff guisp=#ff00ff gui=NONE ctermfg=15 ctermbg=13 cterm=NONE
...
hi SignColumn guifg=#008080 guibg=#c0c0c0 guisp=#c0c0c0 gui=NONE ctermfg=6 ctermbg=7 cterm=NONE
...
hi SpellBad guifg=NONE guibg=NONE guisp=#ff0000 gui=undercurl ctermfg=1 ctermbg=7 cterm=NONE
hi SpellCap guifg=NONE guibg=NONE guisp=#0000ff gui=undercurl ctermfg=4 ctermbg=7 cterm=NONE
hi SpellLocal guifg=NONE guibg=NONE guisp=#008080 gui=undercurl ctermfg=6 ctermbg=7 cterm=NONE
hi SpellRare guifg=NONE guibg=NONE guisp=#808080 gui=undercurl ctermfg=8 ctermbg=7 cterm=NONE
hi Statement guifg=#000080 guibg=NONE guisp=NONE gui=NONE ctermfg=4 ctermbg=NONE cterm=NONE
hi StatusLine guifg=#ffffff guibg=#808080 guisp=#808080 gui=NONE ctermfg=15 ctermbg=8 cterm=NONE
hi StatusLineNC guifg=#c0c0c0 guibg=#808080 guisp=#808080 gui=NONE ctermfg=7 ctermbg=8 cterm=NONE
...
hi TabLine guifg=#c0c0c0 guibg=#000000 guisp=#000000 gui=NONE ctermfg=7 ctermbg=0 cterm=NONE
hi TabLineFill guifg=NONE guibg=#000000 guisp=#000000 gui=NONE ctermfg=NONE ctermbg=0 cterm=NONE
hi TabLineSel guifg=#ffffff guibg=#000000 guisp=#000000 gui=NONE ctermfg=15 ctermbg=0 cterm=NONE
...
hi Todo guifg=#000000 guibg=#ffff00 guisp=#ffff00 gui=bold ctermfg=0 ctermbg=11 cterm=underline
...
hi VertSplit guifg=#c0c0c0 guibg=#808080 guisp=#808080 gui=NONE ctermfg=7 ctermbg=8 cterm=NONE
...
hi WildMenu guifg=#ffff00 guibg=#808080 guisp=#808080 gui=NONE ctermfg=11 ctermbg=8 cterm=NONE
